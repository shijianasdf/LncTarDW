...
public class hdfregulatory {
	...
	public hdfregulatory(String diseasename,String regulator,String regulatorymechanism,String target,String influencedfunction,String drugs){
		//echarts网络
	...
	public String getLevelofregulation() {
		return levelofregulation;
	}
	public void setLevelofregulation(String levelofregulation) {
		this.levelofregulation = levelofregulation;
	}
	...
	public String getCancerstemcell() {
		return cancerstemcell;
	}
	public void setCancerstemcell(String cancerstemcell) {
		this.cancerstemcell = cancerstemcell;
	}
	...
	public String getMethodfcor() {
		return methodfcor;
	}


	public void setMethodfcor(String methodfcor) {
		this.methodfcor = methodfcor;
	}


	public String getMethodfexp() {
		return methodfexp;
	}


	public void setMethodfexp(String methodfexp) {
		this.methodfexp = methodfexp;
	}


	public String getDataaccession() {
		return dataaccession;
	}


	public void setDataaccession(String dataaccession) {
		this.dataaccession = dataaccession;
	}
	...
	public  hdfregulatory(){
		
	}

	public hdfregulatory(String diseasename, String regulator, String target, String regulatorytype,
			String levelofregulation, String regulationdiretion, String methodfcor, String expressionpattern,
			String methodfexp, String dataaccession, String influencedfunction, String regulatorymechanism,
			String drugs, String cancerstemcell, String hallmark, String pubmedid, String diseasecategory,
			String diseasename2, String regulatortype, String targettype, String regulatorensembleid,
			String targetensembleid, String regulatorentrezid, String targetentrezid, String regulatoraliases,
			String targetaliases, String evidence, String rid, String searchregulatorymechanism) {
		this.diseasename = diseasename;
		this.regulator = regulator;
		this.target = target;
		this.regulatorytype = regulatorytype;
	...
	public hdfregulatory(String diseasename, String regulator, String target, String regulationdiretion,String expressionpattern,
			             String influencedfunction,String regulatorymechanism, String drugs,String cancerstemcell, String hallmark, String pubmedid,String rid){
		//首页面展示字段
		this.diseasename = diseasename;
		this.regulator = regulator;
		this.target = target;
