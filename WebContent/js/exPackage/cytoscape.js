...
function PPI(node,edge,des ) {
	...
	var options = {
		swfPath: "./js/cytoscape_web/swf/CytoscapeWeb",//swf所在的路径，但不要拓展名
		flashInstallerPath: "./js/cytoscape_web/swf/playerProductInstall"//Flash Player
	};
	...
	vis.ready(function() {
		...
		document.getElementById("png").onclick = function(){ 
			downloadFile(document.getElementById("ddpng"),"a.png",vis.png());
			}
